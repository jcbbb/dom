...
export let table = (...args) => create_node("table", ...args);
export let th = (...args) => create_node("th", ...args);
export let thead = (...args) => create_node("thead", ...args);
export let td = (...args) => create_node("td", ...args);
export let tbody = (...args) => create_node("tbody", ...args);
export let tr = (...args) => create_node("tr", ...args);
